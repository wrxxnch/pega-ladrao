                ...
                <div class="modal-body">
                    ...
                    <div class="card text-center mb-3">
                        <div class="card-body">
                            ...
                            <hr>
                            <button @click="copySecretMessage" class="btn btn-primary btn-sm">Copiar 📋</button>
                        </div>
                    </div>
                    <h5 class="card-title mb-3">Descriptografar Mensagem 🔓</h5>
                    <div class="mb-3">
                        <label for="inputSecretKey" class="form-label">Informe a chave secreta 🔑</label>
                        <div class="row g-3">
                            <div class="col">
                    ...
                    <br>
                    <button @click="request" type="button" class="btn btn-primary btn-lg">Ativar</button>
